<template>
  <div>
    ...
    <div class="bg-white relative">
      <div
        class="mj-container py-12 border-t-4 border-b-4 border-dashed border-custom-green"
      >
        ...
        <p class="text-gray-600 mb-8">
          ...
          <span class="font-medium text-custom-blue font-sri"
            >October 1st to December 31st, 2017</span
          >. Its primary goal is to monitor food assistance closely, ensuring dignity,
          reducing conflict risks, and improving aid effectiveness in targeted
          municipalities.
        </p>
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div class="bg-white shadow p-6 border border-blue-100">
            ...
            <p class="text-sm text-gray-600">
              Systematic monitoring of food and nutrition storage mechanisms provided by
              WFP, including reception, storage, and post-distribution data consolidation.
            </p>
          </div>
          ...
          <div class="bg-white shadow p-6 border border-green-100">
            ...
            <p class="text-sm text-gray-600">
              On-site monitoring of PRRO and EMOP activities, ensuring alignment with
          ...
          <div class="bg-white shadow p-6 border border-yellow-100">
            ...
            <p class="text-sm text-gray-600">
              Supervision of food, cash, and voucher distributions, covering protection,
              gender, accountability, and site safety.
            </p>
          </div>
          ...
          <div class="bg-white shadow p-6 border border-purple-100">
            ...
            <p class="text-sm text-gray-600">
              Ensure the food basket meets WFP standards and that distributions follow
              agreed schedules.
            </p>
          </div>
          ...
          <div class="bg-white shadow p-6 border border-red-100">
            ...
            <p class="text-sm text-gray-600">
              Produce monthly reports to the WFP Diffa Sub-Office on partner activities
          ...
          <div class="bg-white shadow p-6 border border-indigo-100">
            ...
            <p class="text-sm text-gray-600">
              62 school canteens, 12 CRENAMs, and 18 DGCs in Bosso, Kabléwa, N’gourti,
              N’guigmi, and Toumour.
            </p>
          </div>
        </div>
        ...
        <div class="absolute bottom-0 flex justify-center items-center z-50">
          <span
