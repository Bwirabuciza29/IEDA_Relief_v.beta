<template>
  <div class="bg-green-50">
    ...
    >
      <div class="text-center">
        <img
          src="/img/bg/lol.png"
          alt="Chargement"
          class="w-auto h-24 animate-bounce mb-4 mx-auto bg-white p-2 border-t border-b border-custom-green"
        />
    ...
    <div v-if="selectedPays === 'All'">
      <div class="mj-container relative mt-20">
        <div class="relative z-10">
          <div class="flex flex-col md:flex-row items-center md:justify-between py-10">
    ...
    <div v-else-if="selectedPays === 'Burkina Faso'" class="relative mt-20">
      <burkina />
    </div>
