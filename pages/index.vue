<template>
  <div class="bg-green-50">
    ...
    <div v-else-if="selectedPays === 'USA'" class="mj-container relative mt-20">
      <div class="relative z-10">
        <div
          class="flex flex-col md:flex-row items-center md:justify-between py-10"
        >
    ...
    <div
      ...
      class="mj-container relative mt-20"
    >
      <div class="relative z-10">
        <div
          class="flex flex-col md:flex-row items-center md:justify-between py-10"
    ...
    <div v-else-if="selectedPays === 'CAR'" class="mj-container relative mt-20">
      <div class="relative z-10">
        <div
          class="flex flex-col md:flex-row items-center md:justify-between py-10"
        >
    ...
    <div v-else-if="selectedPays === 'DRC'" class="mj-container relative mt-20">
      <div class="relative z-10">
        <div
          class="flex flex-col md:flex-row items-center md:justify-between py-10"
        >
